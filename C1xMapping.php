...
<html>
 <head>
  <title>C1x Mapping - Search Page test</title>
...
<form name='form1' action="C1xParser.php" method="post" target="Show_Log">  
...
<table border=0>
 ...
 <tr> 
		...
		<td align='left' colspan='2'><input id="CustomerObjectID" name="CustomerObjectID" type="text" size="55" value="fbf99a169172406c74684e0a9b8b5af3e439b06e" onClick="this.value=''">  </td>  
 </tr>
